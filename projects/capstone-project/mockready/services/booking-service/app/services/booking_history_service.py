...
from app.repositories.booking_history_repository  import BookingHistoryRepository
...
class BookingHistoryService:
    ...
    async def create(self, data: BookingHistoryCreate) -> BookingHistoryResponse:
        booking = await self.booking_history_repo.create(data)
    ...
    async def get_by_id(self, booking_history_id: int)-> BookingHistoryResponse:
        booking = await self.booking_history_repo.get_by_id(booking_history_id)
        return BookingHistoryResponse.model_validate(booking)
